...
class MacOsSocket final : public ISocket {
public:
  explicit MacOsSocket(SocketType type);
  ~MacOsSocket() override;
...
private:
  explicit MacOsSocket(int fd, SocketType type, bool connected);
...
class MacOsSocketDriver final : public ISocketDriver {
public:
