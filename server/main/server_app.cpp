...
void print_usage() {
  std::cout
      ...
      << "\n"
      << "This executable is the future formal Audio Studio Server entry point.\n"
      << "M0 intentionally only proves the top-level repository layout and build\n"
      << "boundaries. JSON-RPC, framework services, drivers, and platform backends\n"
