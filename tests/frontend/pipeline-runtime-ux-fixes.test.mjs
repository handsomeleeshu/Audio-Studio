...
assert.ok(!html.includes('lockedRunDrag'), 'running/loaded state should no longer block pure layout dragging');
assert.ok(!html.includes('Run 状态下不能自动布局，请先 Stop'), 'Auto Arrange should remain available while loaded/running');
