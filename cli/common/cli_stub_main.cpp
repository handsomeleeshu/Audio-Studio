...
void print_usage() {
  std::cout
      ...
      << "\n"
      << "This is a lightweight CLI front-end placeholder. Per design, CLI tools\n"
      << "will remain thin JSON-RPC clients and will not link directly against\n"
      << "server framework, platform drivers, or Audio Controller protocol code.\n";
}
